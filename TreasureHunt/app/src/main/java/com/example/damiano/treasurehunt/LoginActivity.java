 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, BackgroundActions {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView modelTextview = (TextView) findViewById(R.id.link_signup);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new BackgroundTask(/*email, password,*/ "{'message_type':'1',\n" + "'email': '" + email + "',\n" + "'password': '" + password + "',\n }", this);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.damiano.treasurehunt/http/host/path")
        );
